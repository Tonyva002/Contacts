...
class CustomAdapterGrid(var context: Context, items: ArrayList<Contact>): BaseAdapter() {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        if (view == null){
            view = LayoutInflater.from(context).inflate(R.layout.grid_contact, null)
    ...
    private class ViewHolder(view: View) {
        val name: TextView = view.findViewById(R.id.tvGridName)
        val photo: ImageView = view.findViewById(R.id.gridPhoto)
